...
export class NgPagination implements OnChanges {
  ...
  @ContentChild(NgPaginationEllipsis, { static: false }) tplEllipsis: NgPaginationEllipsis | undefined;
  @ContentChild(NgPaginationFirst, { static: false }) tplFirst: NgPaginationFirst | undefined;
  @ContentChild(NgPaginationLast, { static: false }) tplLast: NgPaginationLast | undefined;
  @ContentChild(NgPaginationNext, { static: false }) tplNext: NgPaginationNext | undefined;
  @ContentChild(NgPaginationNumber, { static: false }) tplNumber: NgPaginationNumber | undefined;
  @ContentChild(NgPaginationPrevious, { static: false }) tplPrevious: NgPaginationPrevious | undefined;
